        ...
        <section className="w-full max-w-6xl mx-auto py-20 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                Our proprietary model provides a fair, unbiased credit score, opening up opportunities for more borrowers.
              </CardContent>
            </Card>
            <Card>
              <CardHeader><CardTitle>Insured by the Community</CardTitle></CardHeader>
              <CardContent>
                Lenders are protected by a decentralized insurance pool that automatically compensates for defaults.
              </CardContent>
            </Card>
            <Card>
              <CardHeader><CardTitle>Transparent & On-Chain</CardTitle></CardHeader>
              <CardContent>
                Every transaction is recorded and verifiable, ensuring complete transparency and trust in the platform.
              </CardContent>
            </Card>
          </div>
        </section>
